...
开关：开启/关闭 群聊决策；开启审查/关闭审查 人工审查；审批概率 30 设置 30% 免审直发。
...
D 开关：D1审查状态 D2开启审查 D3关闭审查 D4开启群聊 D5关闭群聊 D6审批概率。
...
5. 只有主人/工具管理员能改黑话。""",
    "switch": """bot工具 开关：
快捷：D1审查状态；D2开启审查；D3关闭审查；D4开启群聊；D5关闭群聊；D6审批概率。
