...
7. 加记忆：内容：主人手动写入一条长期记忆；删记忆 123：删除指定记忆单元。
8. 记忆来源：短期上下文外的旧聊天，由 memory 模型压缩成回想。
9. 风格来源：最近群友原文，由 style 模型抽取“场景 -> 表达策略”。
10. 群友画像来源：后端实时统计每个人原文；每天最多一次用 member_profile 模型给活跃群友补摘要。
