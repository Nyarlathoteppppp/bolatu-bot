...
基础审批人只能用 A/B/C/D/X/1/2/3/取消；3370998238 额外可查/调审批概率 60-100。"""
...
8. 3370998238 额外可用 审批概率 / 审批概率 60-100；低于 60 会拒绝。""",
    "view": """bot工具 查看：
...
5. 3370998238 有例外权限：可发 审批概率 查询，可发 审批概率 60/80/100 调整免审自动发送概率。""",
    "private": """bot工具 私聊：
快捷：G1 私聊白名单。
